    ...
    <div id="headerBot" :class="['header', 'sticky', { 'hidden': isHeaderHidden }]">
        ...
        <div class="header__links">
            <router-link to="/filmes" class="text-white"><span
                    class="links-2 hvr-underline-from-center">Filmes</span></router-link>
            <router-link to="/series" class="text-white"><span
                    class="links-2 hvr-underline-from-center">Séries</span></router-link>
