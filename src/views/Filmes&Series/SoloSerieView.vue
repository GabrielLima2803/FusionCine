                ...
                <div class="container-main">
                    <div class="container-tv z-3">
                        ...
                        <div class="info-tv">
                            ...
                            <div class="contianer-writer">
                                <h1>Diretor</h1>
                                <p>{{ getDirectorName(tv.credits.crew) }}</p>
                                <div v-if="tv.credits.crew.length > 0">
                                    <h1>Escritores</h1>
                                    <div v-for="(writer, index) in getWriters(tv.credits.crew)" :key="index">
                                        <p>{{ writer.name }}</p>
                                    </div>
                                </div>
