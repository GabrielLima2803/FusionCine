...
<template>
<header-principal />
  <div v-for="serie in tvs" :key="serie.id">
    <div class="backdrop">
      <div class="backdrop" :style="{
        'background-image': `linear-gradient(to right, rgb(16, 14, 14) 150px, rgba(16, 14, 14, 0.84) 100%),url(https://image.tmdb.org/t/p/original${serie.backdrop_path})`
      }">
        <div class="container-main">
          <div class="container-serie z-3">
            <img :src="`https://image.tmdb.org/t/p/w500${serie.poster_path}`" :alt="serie.title" width="350"
              class="img-serie" />
          ...
          <div class="trailer mt-5">
            <button @click="openTrailer(serie.videos && serie.videos.results)">
  ...
  <div v-for="(castMember) in serie.credits.cast.slice(0, showMoreCast ? undefined : maxVisibleCastMembers)"
    ...
    <div class="info-gener">
      <div class="col-lg-4 col-md-4 col-12">
        <div class="info text-center text-md-left m-20">
          ...
          <div class="info-sobre">
            ...
            <h6 class="mt-3"> {{ getGenreNames(serie.genres) }}</h6>
            <div class="sinop">
        ...
        <div class="info-item p-20">
          ...
          <h6 class="mt-4 ml-5">{{ serie.original_title }}</h6>
        </div>
      </div>
      ...
      <div class="informacoes">
        <div class="info-col">
          ...
          <div class="info-item">
            <h6>Lançamento</h6>
            <!-- <p class="serie-date mt-1">{{ formatDate(serie.release_date) }}</p> -->
          </div>
          <div class="info-item">
            <h6>Duração</h6>
            <!-- <p class="mt-1">{{ getFormattedRuntime(serie.runtime) }}</p> -->
          </div>
          <div class="info-item">
            <h6>Genêro</h6>
            <p class="mt-1">{{ getGenreNames(serie.genres) }}</p>
          </div>
        </div>
        ...
        <div class="info-col">
          ...
          <div class="info-item">
            <h6>Situação</h6>
            <p class="mt-1">{{ serie.status }}</p>
          </div>
          <div class="info-item">
            <h6>Orçamento</h6>
            <p class="mt-1">${{ serie.budget }}</p>
          </div>
          <div class="info-item">
            <h6>Receita</h6>
            <p class="mt-1">${{ serie.revenue }}</p>
          </div>
        </div>
        ...
        <div class="info-col">
          ...
          <div class="keyword-grid">
            <div v-for="(keyword, index) in getKeywordsNames(serie.keywords)" :key="index" class="keyword-item">
